...
<head>
  ...
  <title>New Zealand Mountain Biking | Compass</title>
  <style>
    body {
      margin: 0;
  ...
  <main>
    <div class="content">
      <div class="page-header">
        <h1>New Zealand's Upper Hutt Mountain Biking</h1>
        <div class="price-tag">$1490 - 3 Days</div>
      </div>

      <div class="package-details">
        <p>The Karapoti Trail, home to the Trek Karapoti Classic, twists around the Akatarawa Range and delivers 31 miles of technical single track and challenging fire road climbs. During the ride, there are several vistas to soothe those eyes while you reward your burning legs by taking a quick breather.</p>

        <p>Upper Hutt is New Zealand's mountain biking hub, and if you're looking for a group ride, stop by Mountain Trails bike shop. Or if you want a number plate on your handlebar, the Trek Karapoti Classic is scheduled for March 4, 2001.</p>
