...
<head>
  ...
  <title>California Surf Safari | Compass</title>
  <style>
    body {
      margin: 0;
  ...
  <main>
    <div class="content">
      <div class="page-header">
        <h1>California Surf Safari</h1>
        <div class="price-tag">$960 - 5 Nights</div>
      </div>
    ...
    <div class="sidebar">
      <div class="photo-gallery">
        ...
        <img src="../assets/images/viewPhotos_off.gif" alt="Surfing photos" class="gallery-thumbnail">
