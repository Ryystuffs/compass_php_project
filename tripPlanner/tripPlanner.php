...
<body>
    ...
    <main>
        ...
        <div class="intro-text">
            ...
            <a href ="tripPlannerMain.php" class="trip-table-btn">UPDATE</a>
        </div>

        <div class="planner-steps">
            <?php                
                        if (isset($_SESSION['error'])) {
                            echo "<p style='color: red; margin: 15px 15px;'>{$_SESSION['error']}</p>";
                            unset($_SESSION['error']);
                        }
            ?>
            <form method="post" action="process-trip-planner.php">
                <div class="step">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="city" class="input-control" name="city" placeholder="e.g. Denver, Kathmandu">
                    </div>
                    
                    <div class="input-group">
                        <label for="country">Country or Region:</label>
                        <input type="text" id="country" class="input-control" name="country" placeholder="e.g. USA, Nepal">
                    </div>
                </div>
                ...
                <div class="step">
                    ...
                    <div class="checkbox-group">
                        ...
                        <div class="checkbox-item">
                            <input type="checkbox" id="kayaking" name="activities[]" value="Kayaking">
                        ...
                        <div class="checkbox-item">
                            <input type="checkbox" id="mountain-biking" name="activities[]" value="Mountain Biking">
                            <label for="mountain-biking">Mountain Biking</label>
                        </div>
                        <div class="checkbox-item">
                            <input type="checkbox" id="skiing" name="activities[]" value="Skiing">
                ...
                <div class="step">
                    ...
                    <div class="checkbox-item">
                        <input type="checkbox" id="political" name="info[]" value="Political">
